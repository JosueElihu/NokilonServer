...
Public Event BkgndDraw(Hdc As Long, Width As Long, Height As Long, ByRef Cancel As Boolean)
        ...
        Case UserControl.hwnd
            ...
            Select Case uMsg
                ...
                Case WM_ERASEBKGND
                   ...
                   RaiseEvent BkgndDraw(wParam, uRct.x2, uRct.y2, Evt0)
                   
                   If Evt0 Then Exit Sub
